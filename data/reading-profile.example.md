...
agent again after every change to recompute the recommendation list.
...
Books you have read and enjoyed. They form your taste profile and are never
proposed again. English original titles match the Goodreads catalog best —
`data/profile-match.md` shows which entries were recognized.
